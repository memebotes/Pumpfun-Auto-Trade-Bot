...
import { Cpu, LineChart, History, Settings, Bell } from 'lucide-react';
    ...
    <div className="h-screen bg-gray-900 text-gray-100 w-64 flex flex-col shadow-lg">
      <div className="p-4 border-b border-gray-800">
        <div className="flex items-center space-x-2">
          ...
          <h1 className="text-xl font-bold">pump.fun Bot</h1>
        </div>
        <p className="text-xs text-gray-500 mt-1">Solana Trading Bot v1.0</p>
      </div>
              ...
              <Link
                ...
                className={`flex items-center px-4 py-3 transition-colors ${
                  location.pathname === item.path
                    ? 'bg-indigo-900/30 text-indigo-400 border-l-2 border-indigo-400'
